...
<section class="bussinesscard">
		<div class="flip">
			<div class="front">
				<div class="top">
					<div class="logo"><span class="fat"><?= substr($contact['type'], 0, 1) ?></span><span class="skinny"><?= substr($contact['type'], 1) ?></span></div>
</div>
<div class="nametroduction">
    <div class="name"><?= $contact['first_name'] . ' ' . $contact['last_name'] ?></div>
    <div class="introduction"><?= $contact['company'] ?></div>
</div>
<div class="contact">

    <?php if ($contact['mobile'] != null) {
        echo '<div class="phone ">';
        echo '<span class="ion-ios7-telephone"></span>';
        echo '' . $contact['mobile'] . '';
        echo '</div>';
    } ?>
    ...
    <?php if ($contact['email'] != null) {
        ...
        echo '<span class="ion-paper-airplane"></span>';
        echo '' . $contact['email'] . '';
        echo '</div>';
    } ?>
